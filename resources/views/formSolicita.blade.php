					...
					<form method="POST" action="">
                        @csrf
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="email" placeholder="Digite o seu email">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text"  name="cpf" required placeholder="Informe seu CPF">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-btn">
										<button type="submit" class="submit-btn" id="form-title1">Enviar</button>
									</div>
								</div>
